...
//         "'net.boomerangplatform.mongo.service.CiComponentActivityService"
// })
...
//     Assertions.assertEquals(5, operators.size());
//     Assertions.assertEquals("Equals", operators.get("EQUALS"));
//   }
...
//     Assertions.assertEquals("Tim Testing Policies", policy.getName());
//     Assertions.assertEquals("5db85e35110fc4000140a5ad", policy.getId());
//     Assertions.assertEquals(teamId, policy.getTeamId());

//     Assertions.assertEquals(1, policy.getDefinitions().size());

//     PolicyDefinition definition = policy.getDefinitions().get(0);
//     Assertions.assertEquals("5cd49777f6ea74a9bb6ac629", definition.getPolicyTemplateId());

//     Assertions.assertEquals(1, definition.getRules().size());
//     Map<String, String> rule = definition.getRules().get(0);

//     Assertions.assertEquals("issues-total", rule.get("metric"));
//     Assertions.assertEquals("1", rule.get("value"));
//   }
...
//     Assertions.assertEquals("Code High Validation", policyReturn.getName());
//     Assertions.assertEquals(1, policyReturn.getDefinitions().size());
...
//     Assertions.assertEquals(0, insights.size());
//   }
...
//     Assertions.assertEquals("5db85e35110fc4000140a5ad", savedEntity.getPolicyId());
//     Assertions.assertEquals(Boolean.FALSE, savedEntity.getValid());
//     Assertions.assertEquals(1, savedEntity.getResults().size());
//     Assertions.assertEquals(Boolean.FALSE, savedEntity.getResults().get(0).getValid());
//     Assertions.assertEquals(false, savedEntity.getResults().get(0).getViolations().get(0).getValid());
//     Assertions.assertEquals("5cd49777f6ea74a9bb6ac629",
...
//     Assertions.assertEquals("5db9a8c7b01c530001b838d1", savedEntity.getPolicyId());
//     Assertions.assertEquals(Boolean.FALSE, savedEntity.getValid());
//     Assertions.assertEquals(1, savedEntity.getResults().size());
//     Assertions.assertEquals(Boolean.FALSE, savedEntity.getResults().get(0).getValid());
//     Assertions.assertEquals(false, savedEntity.getResults().get(0).getViolations().get(0).getValid());
...
//     Assertions.assertEquals("5dba1ce19e0f890001153730", savedEntity.getPolicyId());
//     Assertions.assertEquals(Boolean.FALSE, savedEntity.getValid());
//     Assertions.assertEquals(1, savedEntity.getResults().size());
//     Assertions.assertEquals(Boolean.FALSE, savedEntity.getResults().get(0).getValid());
//     Assertions.assertEquals("Security Issue Analysis",
//         savedEntity.getResults().get(0).getViolations().get(0).getMetric());
//     Assertions.assertEquals("5cdd8667f6ea74a9bbaf5022",
//         savedEntity.getResults().get(0).getPolicyTemplateId());
